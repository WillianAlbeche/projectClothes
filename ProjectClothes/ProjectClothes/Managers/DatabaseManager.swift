...
//    }
    ...
    func fetchAllClothes() -> [Clothes] {
        do {
            return try context.fetch(Clothes.fetchRequest())
        }
        catch {
            print(error.localizedDescription)
        }
    ...
    func fetchAllLooks() -> [Look] {
        do {
            return try context.fetch(Look.fetchRequest())
        }
        catch {
            print(error.localizedDescription)
        }
    ...
    static func loggingiCloud(vc: UIViewController){
